...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/backend_api")
}
...
MIGRATION_MODULES = {"sites": "backend_api.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "backend_api.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""team3""", "team3@example.com")]
...
ACCOUNT_ADAPTER = "backend_api.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
